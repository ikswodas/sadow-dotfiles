			...
			callback = function()
				...
				local config = {
					cmd = {
						...
						"-jar",
						vim.fn.expand("$MASON/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"),
						"-configuration",
						vim.fn.expand("$MASON/packages/jdtls/config_" .. (vim.fn.has("mac") == 1 and "mac" or "linux")),
						"-data",
